...
namespace kwd {
	...
	Options resolveOption(std::string input){
		static const std::map<std::string, Options> optionStrings {
			...
			{ "fenv_t", fenv_t },
			{ "fexcept_t", fexcept_t },
			{ "FE_DIVBYZERO", FE_DIVBYZEROz },
			{ "FE_INEXACT", FE_INEXACTz },
			{ "FE_INVALID", FE_INVALIDz },
			{ "FE_OVERFLOW", FE_OVERFLOWz },
			{ "FE_UNDERFLOW", FE_UNDERFLOWz },
			{ "FE_ALL_EXCEPT", FE_ALL_EXCEPTz },
			{ "FE_DOWNWARD", FE_DOWNWARDz },
			{ "FE_TONEAREST", FE_TONEARESTz },
			{ "FE_TOWARDZERO", FE_TOWARDZEROz },
			{ "FE_UPWARD", FE_UPWARDz },
			{ "FE_DFL_ENV", FE_DFL_ENVz },
			{ "FENV_ACCESS", FENV_ACCESSz },
			{ "<climits>", <climits> },
			{ "<cfloat>", <cfloat> },
			...
			{ "NAN", NANz },
			{ "HUGE_VAL", HUGE_VALz },
			{ "HUGE_VALF", HUGE_VALFz },
			{ "HUGE_VALL", HUGE_VALLz },
			{ "double_t", double_t },
			{ "float_t", float_t },
			{ "longjmp", longjmp },
			{ "setjmp", setjmp },
			...
			{ "BUFSIZ", BUFSIZz },
			{ "EOF", EOFz },
			{ "FILENAME_MAX", FILENAME_MAXz },
			{ "FOPEN_MAX", FOPEN_MAXz },
			{ "L_tmpnam", L_tmpnam },
			{ "TMP_MAX", TMP_MAXz },
			{ "FILE", FILEz },
			{ "fpos_t", fpos_t },
			...
			{ "mbstowcs", mbstowcs },
			{ "wcstombs", wcstombs },
			{ "EXIT_FAILURE", EXIT_FAILUREz },
			{ "EXIT_SUCCESS", EXIT_SUCCESSz },
			{ "MB_CUR_MAX", MB_CUR_MAXz },
			{ "RAND_MAX", RAND_MAXz },
			{ "div_t", div_t },
			{ "ldiv_t", ldiv_t },
			{ "lldiv_t", lldiv_t },
			...
			{ "localtime", localtime },
			{ "strftime", strftime },
			{ "CLOCKS_PER_SEC", CLOCKS_PER_SECz },
			{ "clock_t", clock_t },
			{ "time_t", time_t },
			{ "structtm", structtm },
			{ "c16rtomb", c16rtomb },
			...
			{ "wchar_t", wchar_t },
			{ "wint_t", wint_t },
			{ "WCHAR_MAX", WCHAR_MAXz },
			{ "WCHAR_MIN", WCHAR_MINz },
			{ "WEOF", WEOFz },
			{ "iswalnum", iswalnum },
			{ "iswalpha", iswalpha },
			{ "iswblank", iswblank },
			...
			{ "ATOMIC_VAR_INIT", ATOMIC_VAR_INITz },
			{ "ATOMIC_FLAG_INIT", ATOMIC_FLAG_INITz },
