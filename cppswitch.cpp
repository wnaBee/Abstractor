...
break;
case "islower":
comment += "Check if character is lowercase letter "
break;
case "isprint":
...
break;
case "isupper":
comment += "Check if character is uppercase letter "
break;
case "isxdigit":
comment += "Check if character is hexadecimal digit "
break;
case "tolower":
comment += "Convert uppercase letter to lowercase "
break;
case "toupper":
comment += "Convert lowercase letter to uppercase "
break;
case "":
comment += ""
break;
...
comment += "(float.h)"
break;
case "Characteristics of floating-point types ":
comment += ""
break;
case "":
comment += ""
...
comment += "lconv"
break;
case "Formatting info for numeric values ":
comment += ""
break;
case "setlocale":
...
break;
case "iswlower":
comment += "Check if wide character is lowercase letter "
break;
case "iswprint":
...
break;
case "iswupper":
comment += "Check if wide character is uppercase letter "
break;
case "iswxdigit":
comment += "Check if wide character is hexadecimal digit "
break;
case "towlower":
comment += "Convert uppercase wide character to lowercase "
break;
case "towupper":
comment += "Convert lowercase wide character to uppercase "
break;
case "iswctype":
...
comment += "(duration)"
break;
case "Specialization of common_type for duration ":
comment += ""
break;
case "duration_cast":
...
comment += "new"
break;
case "Allocate storage space ":
comment += ""
break;
case "operator":
comment += "new[]"
break;
case "Allocate storage space for array ":
comment += ""
break;
case "operator":
comment += "delete"
break;
case "Deallocate storage space ":
comment += ""
break;
case "operator":
comment += "delete[]"
break;
case "Deallocate storage space of array ":
comment += ""
break;
...
comment += "syntax"
break;
case "ECMAScript regular expressions pattern syntax ":
comment += ""
break;
case "begin":
comment += "Iterator to beginning "
